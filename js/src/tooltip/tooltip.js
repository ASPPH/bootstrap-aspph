...
class Tooltip extends BaseComponent {
  ...
  dispose() {
    ...
    EventHandler.off(SelectorEngine.closest(this._element, '.modal'), 'hide.bs.modal', this._hideModalHandler)
  ...
  _setListeners() {
    ...
    EventHandler.on(SelectorEngine.closest(this._element, '.modal'),
      'hide.bs.modal',
      this._hideModalHandler
    )
